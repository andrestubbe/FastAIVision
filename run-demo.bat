...
cd /d "%~dp0"
echo ===================================================
echo  Building FastAIVision & Running Live Demo
echo ===================================================
